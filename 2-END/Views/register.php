...
<form action="registerUser" method="post">
    ...
    <input required type="email" name="email" value="<?php echo isset($_SESSION['old_user']) ? $_SESSION['old_user']['email'] :  '' ?>" placeholder="Enter your email">
    <?php if (isset($_SESSION['mail_error'])) echo "<br>" . $_SESSION['mail_error'] ?>
    <br>
    <input value="<?php echo isset($_SESSION['old_user']) ? $_SESSION['old_user']['name'] :  '' ?>" required type="text" name="name" placeholder="Enter your name">
    <br>
